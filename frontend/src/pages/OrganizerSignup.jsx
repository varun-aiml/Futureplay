        ...
        <div className="bg-gray-800 py-8 px-4 shadow-lg sm:rounded-lg sm:px-10 border border-gray-700">
              ...
              {formData.password && (
                <div className="mt-2">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <div className="text-xs font-medium" style={{ color: passwordStrength >= 3 ? '#10B981' : passwordStrength >= 2 ? '#F59E0B' : '#EF4444' }}>
                      {getStrengthText()}
                    </div>
                  </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-400">
              ...
              <Link to="/organizer/login" className="font-medium text-red-400 hover:text-red-300">
                Sign in
              </Link>
            </p>
          </div>
